...
export default function EducationItem({ date, title, company, details }:EducationItemProps) {
  return (
    ...
    <div className="bg-teal-800 text-white px-4 py-2 rounded-lg mb-4 md:mb-0 md:mr-6 text-center w-48">
      {date}
    </div>
    <div className="flex items-center md:items-start">
      <div className="w-4 h-4 bg-teal-800 rounded-full mr-4 md:mr-6 z-10 border-2 border-[#6B5B95]"></div>
      <div>
